        ...
        <div className='bg-[#f6f3ef] md:p-0 p-[50px]  my-[60px] md:my-[100px]'>
            <div className='md:flex items-center justify-between'>
                <div className='md:w-1/2 flex flex-col justify-center items-center'>
                    ...
                    <p className='md:w-[400px] md:py-[15px] py-[20px] text-center'>Jewelry is favored by both men and women because it shows luxury & class; own aesthetic taste, affirming position…</p>
                </div>
